        ...
        <CardFooter className="p-0 pt-[5px] pb-[32px] px-5 md:px-20 lg:px-[42px]">
          <div className="w-full flex items-center justify-between flex-wrap gap-[24px]">
            <div className="max-w-[360px] w-full flex flex-col gap-[8px]">
              ...
              <BodyText level="body2">{description}</BodyText>
            </div>
            {!ctaButton && (
              <Button
                ...
                variant={'primary'}
                size={'lg'}
                className="capitalize w-full min-[426px]:w-fit rounded-4"
              >
                {ctaText}
              </Button>
            )}
            {ctaButton && <div className="w-full min-[426px]:w-fit">{ctaButton}</div>}
          </div>
        </CardFooter>
      </Card>
    </MainContainer>
