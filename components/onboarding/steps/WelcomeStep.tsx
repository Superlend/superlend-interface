...
export const WelcomeStep: React.FC = () => {
  return (
    <div className="flex flex-col items-center h-full text-center space-y-4 sm:space-y-6 py-4 sm:py-8 px-4 sm:px-0">
      {/* Hero Section */}
      <motion.div
      ...
      <motion.div
        ...
        className="space-y-3 sm:space-y-4 md:space-y-6 w-full max-w-3xl flex-1 flex flex-col justify-center"
      >
