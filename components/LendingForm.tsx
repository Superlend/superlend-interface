            ...
            <div className="flex flex-col w-full bg-white rounded-2xl min-h-[148px] max-md:max-w-full">
                ...
                >
                    ...
                    <div className="flex gap-1 justify-center items-center self-stretch px-2 my-auto w-8 h-8 rounded-xl border border-gray-100 border-solid bg-neutral-50">
                        <img
                            loading="lazy"
                            src="https://cdn.builder.io/api/v1/image/assets/TEMP/00f989f077b46028d448d8135ad466f4a7d9567d2f8758b82ca59769a1882633?placeholderIfAbsent=true&apiKey=689e79da645a41c0a4332461eb09084b"
                            alt="Select token"
                ...
                <p className="self-center mt-4 text-sm tracking-normal leading-5 text-center text-stone-500 px-3 sm:w-[35ch]">
                    Earn better returns on your assets choose token to see
                    opportunities
                </p>
            </div>
            <button
                type="submit"
                className="group flex gap-1 justify-center items-center px-6 py-3.5 mt-5 w-full text-sm font-semibold tracking-normal leading-none text-white uppercase rounded-2xl bg-orange-600 min-h-[44px] max-md:px-5 max-md:max-w-full disabled:opacity-[0.44] disabled:cursor-not-allowed"
                disabled
            >
                <span className="self-stretch my-auto group-disabled:opacity-[0.44]">
                    View Opportunities
                </span>
                <img
                    loading="lazy"
                    src="https://cdn.builder.io/api/v1/image/assets/TEMP/9c5dbfd82534b427e0fe7154827804f183a46b286552c85dbbdde7cc8e3965c0?placeholderIfAbsent=true&apiKey=689e79da645a41c0a4332461eb09084b"
                    alt=""
