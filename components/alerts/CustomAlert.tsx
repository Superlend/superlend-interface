    ...
    <Alert variant={variant}>
      <AlertDescription className="flex items-center justify-center gap-2">
        ...
        {hasPrefixIcon && variant === 'warning' && (
          <TriangleAlert width={18} height={18} className="stroke-warning-foreground shrink-0" />
        )}
        {hasPrefixIcon && variant === 'info' && (
          <InfoIcon width={18} height={18} className="stroke-info-foreground shrink-0" />
        )}
