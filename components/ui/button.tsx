...
const buttonVariants = cva(
  "group inline-flex items-center justify-center whitespace-nowrap rounded-3 font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:select-none disabled:opacity-50 hover:scale-105 active:scale-100 transition-transform duration-150",
  {
    variants: {
      variant: {
