...
const buttonVariants = cva(
  "group inline-flex items-center justify-center whitespace-nowrap rounded-3 font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:select-none disabled:opacity-50 sm:hover:scale-105 sm:hover:active:scale-95 transition-transform duration-150 [&.selected]:border-1 [&.selected]:border-secondary-500 [&.selected]:ring-2 md:[&.selected]:ring-1 [&.selected]:ring-secondary-100",
  {
    variants: {
      variant: {
        default: "bg-white text-gray-800 border border-gray-300 hover:bg-gray-200 active:opacity-75 disabled:text-gray-800",
        primary: "bg-gradient-to-b from-primary-gradientStart to-primary-gradientEnd text-primary-foreground hover:to-primary-gradientEndHover active:to-primary-gradientEndActive active:text-primary-foreground/75 disabled:text-primary-foreground/75 border-2 border-orange-600",
        destructive:
