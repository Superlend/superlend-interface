        ...
        <MainContainer>
            <Card className='p-0 max-w-[731px] mx-auto'>
                <CardHeader className='p-0 h-fit'>
                    <img src="/images/404-not-found.webp" alt="404 not found" width={731} height={345} className='object-cover' />
                </CardHeader>
                <CardFooter className='p-0 pt-[5px] pb-[32px] px-5 md:px-20 lg:px-[42px]'>
                    <div className="w-full flex items-center justify-between flex-wrap gap-[24px]">
                        ...
                        <Button variant={'primary'} size={'sm'} className='uppercase w-full min-[426px]:w-fit p-0'>
                            <Link href={'/'} className='w-full h-full py-[13px] px-[21px]'>
                                Go to home
                            </Link>
                        </Button>
                    </div>
