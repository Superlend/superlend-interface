...
export default function YourPositionsAtRiskCarousel() {
    ...
    const POSITIONS_AT_RISK = PLATFORMS_WITH_POSITIONS?.map(
                    ...
                    <InfoTooltip
                        content={
                            <BodyText level="body3" weight="normal">
                                The risk level is assessed by the loan&apos;s
                                health factor: a health factor below 1.5 is
                                considered risky, and if it falls below 1, it
                                                ...
                                                <div className="lend-amount-block flex flex-col gap-[4px]">
                                                    ...
                                                    <div className="flex items-center gap-[4px]">
                                                        <AvatarCircles
                                                            ...
                                                            avatarDetails={position.lendAsset.tokenDetails.map(
                                                                (token) => ({
                                                ...
                                                <div className="borrow-amount-block flex flex-col gap-[4px]">
                                                    ...
                                                    <div className="flex items-center justify-end gap-[4px]">
                                                        ...
                                                        <AvatarCircles
                                                            ...
                                                            avatarDetails={position.borrowAsset.tokenDetails.map(
                                                                (token) => ({
