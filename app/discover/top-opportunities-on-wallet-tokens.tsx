...
export default function TopOpportunitiesOnWalletTokens() {
  return (
    <section
      id="top-oppotunities-on-your-wallet-tokens"
      className="top-oppotunities-on-your-wallet-tokens flex flex-col gap-[24px]"
    >
      <div className="section-header flex items-center gap-[12px] px-5">
        <HeadingText level="h3" className="max-[375px]:max-w-[20ch]">
          Top Opportunities on your wallet tokens
        </HeadingText>
        <InfoTooltip />
      </div>
                ...
                <Card className="w-full max-w-[330px] min-[375px]:max-w-[380px]">
                  <CardContent className="relative bg-white overflow-hidden pt-[40px] pb-[21px] pl-[28px] pr-[40px] rounded-b-5">
                    ...
                    <HeadingText
                      level={'h2'}
                      weight="semibold"
                      className="text-success-text mb-[48px]"
                    >
                      16.48% APY
                    </HeadingText>
                  ...
                  <CardFooter className="py-[16px] flex items-center justify-between px-[28px]">
                    <BodyText level="body2" weight="medium" className="text-gray-700 capitalize">
                      Wallet bal: 1,487
                    </BodyText>
