...
import { PlatformDisplayValue, PlatformValue, PlatformWebsiteLink } from './types/platform';
...
export const TOO_MANY_DECIMALS_VALIDATIONS_TEXT = 'Decrease digits after decimal point';
export const CONFIRM_ACTION_IN_WALLET_TEXT = 'Confirm the action in your wallet';
export const CONFIRM_NETWORK_CHANGING = 'Confirm the network changing in your wallet';
