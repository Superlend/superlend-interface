...
export const columns: ColumnDef<TOpportunityTable>[] = [
  ...
  },
  {
    ...
    header: () => {
      ...
      const tooltipContent =
        positionTypeParam === 'lend' ? lendTooltipContent : borrowTooltipContent;
    ...
    cell: ({ row }) => {
      ...
      if (hasRewards) {
        ...
        totalRewards = rewards.reduce(
          (acc, curr) => acc + Number(isLend ? curr.supply_apy : curr.borrow_apy),
          0
        );
        ...
        baseRateFormatted =
          baseRate < 0.01 && baseRate > 0 ? '<0.01' : getFormattedBaseRate(baseRate);
      }
...
function getRewardsTooltipContent({
  ...
  return (
    <div className="flex flex-col divide-y divide-gray-800">
      <BodyText level="body1" weight="medium" className="py-2 text-gray-800/75">
        Rate & Rewards
      </BodyText>
